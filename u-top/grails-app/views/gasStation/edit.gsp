...
<html>
	...
	<body>
		<a href="#edit-gasStation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-gasStation" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${gasStationInstance?.version}" />
				<fieldset class="form">
