			...
			<table>
				...
				<g:each in="${groupProductPricePlanInstanceList}" status="i" var="groupProductPricePlanInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:textField name="plan-id-${groupProductPricePlanInstance.id }" value="${groupProductPricePlanInstance.index }" size="3"/></td>
						...
						<td><g:formatDate date="${groupProductPricePlanInstance.activedStartAt}" /></td>
					
						<td><g:formatDate date="${groupProductPricePlanInstance.activedEndAt}" /></td>
						...
						<td>${groupProductPricePlanInstance?.confirmedBy?.username}</td>
