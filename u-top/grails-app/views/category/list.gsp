			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="enabled" title="${message(code: 'category.enabled.label', default: 'Enabled')}" />
				...
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${categoryInstance.id}">${fieldValue(bean: categoryInstance, field: "enabled")}</g:link></td>
