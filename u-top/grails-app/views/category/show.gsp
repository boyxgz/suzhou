	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.enabled}">
				<li class="fieldcontain">
					<span id="enabled-label" class="property-label"><g:message code="category.enabled.label" default="Enabled" /></span>
					
						<span class="property-value" aria-labelledby="enabled-label"><g:formatBoolean boolean="${categoryInstance?.enabled}" /></span>
