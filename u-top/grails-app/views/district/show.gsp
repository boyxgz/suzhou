	...
	<body>
		...
		<div id="show-district" class="content scaffold-show" role="main">
			...
			<ol class="property-list district">
				...
				<g:if test="${districtInstance?.branch}">
				<li class="fieldcontain">
					<span id="branch-label" class="property-label"><g:message code="district.branch.label" default="Branch" /></span>
					
						<span class="property-value" aria-labelledby="branch-label"><g:link controller="branch" action="show" id="${districtInstance?.branch?.id}">${districtInstance?.branch?.encodeAsHTML()}</g:link></span>
