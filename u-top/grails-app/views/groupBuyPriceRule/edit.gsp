...
<html>
	...
	<body>
		<a href="#edit-groupBuyPriceRule" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-groupBuyPriceRule" class="content scaffold-edit" role="main">
			<h1><g:message code="groupBuyPriceRule.edit.label" args="[entityName]" /></h1>
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${groupBuyPriceRuleInstance?.version}" />
				<fieldset class="form">
