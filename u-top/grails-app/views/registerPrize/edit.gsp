...
<html>
	...
	<body>
		<a href="#edit-registerPrize" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-registerPrize" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${registerPrizeInstance?.version}" />
				<fieldset class="form">
